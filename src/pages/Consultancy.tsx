 ...
 const handleEmployerSubmit = async () => {
  ...
  <div className="space-y-8">
    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <FormSelect
        ...
        onChange={(v) => {
          ...
          handleUpdate("functionalArea", v);

          const selectedArea = functionalAreas.find(
            (a) => a.name === v
          );
    ...
    >
      ...
      <label className="text-[10px] font-bold uppercase text-slate-400 tracking-[0.1em] ml-1">
        Interested Roles
      </label>
      ...
      <div className="grid md:grid-cols-3 gap-3 mt-4">
        ...
        {roles.map((role) => (
          ...
          <label
            key={role.id}
            className="flex items-center gap-3 bg-slate-50 dark:bg-slate-800 px-4 py-3 rounded-xl cursor-pointer hover:border-green-600 border border-transparent transition-all"
          >
    ...
    <FormHeader
      title="Salary & Professional Links"
